...
@pytest.mark.parametrize("shape", [(3, 5), (1, 5), (5, 1), (1, 1), (2, 3, 5), (2, 1, 5), (2, 5, 1), (1, 1, 1), (2, 3, 1, 7)])
@pytest.mark.parametrize("dtype,out_dtype", [("float32", "float32"), ("float16", "float32"), ("int16", "uint8"), ("bool", "int32")])
...
@pytest.mark.parametrize("initialize,shape,scope,annotations,match", [
...
@pytest.mark.parametrize("shape,dtype,out_dtype", [((3, 5), "float32", "float32"), ((2, 1, 5), "float16", "float32"), ((2, 5, 1), "bfloat16", "float32"), ((2, 3, 5), "uint64", "int64")])
